# Sound Agglomerates Explorer

An interactive tool for exploring **sound agglomerates**, a compositional alternative to chord symbols in improvised music.

## What is a Sound Agglomerate?

A *sound agglomerate* is a cluster of pitches defined by intervallic relationships rather than functional harmonic identity. Unlike chord symbols, which trigger idiomatic responses in trained musicians, sound agglomerates specify the exact intervallic structure of a voicing.
...
These constraints produce **95 valid sound agglomerates**.

## Features

- Browse all 95 agglomerates, grouped by span
...
```bash
# Clone the repo
git clone https://github.com/code9/sound-agglomerates.git
cd sound-agglomerates
...
> **"Sound Agglomerates: A Compositional Alternative to Chord Symbols in Improvised Music"**  
